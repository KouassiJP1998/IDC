...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- geoJson Transformation, Anas et Stanislas -->
    <!-- Parse un fichier xml comme "fr_pralognan.xml" en fichier geoJson. Le résultat est lisible avec tout lecteur de geoJson -->
